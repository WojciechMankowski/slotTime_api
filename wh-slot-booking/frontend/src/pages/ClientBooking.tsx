...
import { formatDate, formatTime, getApiError, groupByDay, TYPE_STYLE, STATUS_STYLE } from "../Helper/helper";
import {SlotType, Tab} from '../Types/SlotType'
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 mb-6">
            <div className="flex flex-wrap gap-4 items-end">
              ...
              <FilterField label={t("type", lang)}>
                <select
                  value={typeFilter}
                  onChange={(e) => setTypeFilter(e.target.value as SlotType )}
